  ...
  return (
    <footer className="bg-neutral-950 text-neutral-400">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white text-neutral-900 px-3.5 py-2 rounded-lg text-xs font-semibold hover:bg-neutral-100 transition-colors"
                >
        ...
        {/* Bottom */}
        <div className="flex flex-col sm:flex-row items-center justify-between py-5 border-t border-neutral-800 gap-4">
